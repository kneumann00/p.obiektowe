...
vector<samochod> operacje_na_samochodach::wczytaj()
{
	...
	plik.close();
	return samochody;//miało się przydać, ale jednak nie
}
...
int main()
{
	cout<<"<>Prosze uzywac WIELKICH liter przy wprowadzaniu danych<>"; //podyktowane brakiem czasu
	//vector <samochod> samochody;
	int wybor;
	...
	case 2:
	{
		...
		int war;
		cout<<" - Wybierz warunek\n1.Rocznik (Wiekszy od Kryterium)\n2.Pojemnosc (Wieksza od Kryterium)\n3.Przebieg (Mniejszy od Kryterium)\n";
		cin>>war;
		cout<<"\nKryterium: ";
		switch(war)
		{
